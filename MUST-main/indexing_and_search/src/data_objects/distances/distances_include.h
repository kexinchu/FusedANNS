...
using DistInnerProductModal2 = CGraph::UDistanceCalculator<VecValType2, DistResType2, InnerProduct<VecValType2, DistResType2> >;
#ifdef MODAL2_FLOAT
using DistAttributeSimilarity = DistInnerProductModal2;
#else
