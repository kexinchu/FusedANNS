...
struct ParamConfig {
    ...
    void set_search_param(char *modal1_base_path, char *modal2_base_path,
                          char *modal1_query_path, char *modal2_query_path,
                          char *gt_path, char *res_path, unsigned top_k = 1,
    ...
    void set_per_query_path(const std::string& per_query_path) {
        GA_ALG_PER_QUERY_PATH_ = per_query_path;
    }
...
public:
    ...
    std::string GA_ALG_PER_QUERY_PATH_{};
